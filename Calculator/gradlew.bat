...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="5b83e7c9-b83e-4dce-8286-20a2ba11f22e" name="Default" comment="" />
  ...
  <component name="FileEditorManager">
    <leaf SIDE_TABS_SIZE_LIMIT_KEY="300">
      ...
      <file leaf-file-name="MainActivity.java" pinned="false" current-in-tab="true">
        <entry file="file://$PROJECT_DIR$/app/src/main/java/com/example/reddy/ilahini/MainActivity.java">
          <provider selected="true" editor-type-id="text-editor">
            <state relative-caret-position="289">
              ...
              <folding>
                <element signature="imports" expanded="t